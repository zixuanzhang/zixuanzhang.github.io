...
* Here we constructed an idealized model of heart tissue with an ischemic region and examine how stochastic ion channel dynamics can affect the propensity of reflected waves.
...
The following is an illustrative picture for this model:
